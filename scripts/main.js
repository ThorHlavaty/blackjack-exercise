window.addEventListener('DOMContentLoaded', function() {
  ...
  function pointCalc() {
    ...
    for (let index = 0; index < playerHand.length; index++) {
      ...
      if(point.value === "jack" || point.value === "queen" || point.value === "king"){
        playerPoints += 10;
      }
      ...
      if (playerPoints > 21){setTimeout(function (){
        alert("You bust!")
        location.reload()}, 500)
      }
      return playerPoints;
  ...
  function dealerCalc() {
    ...
    for (let index = 0; index < dealerHand.length; index++) {
      ...
      else {document.getElementById("dealer-points").textContent = `?`}
      if (dealerPoints > 21){setTimeout(function (){
        dealerBust = true
  ...
  function playerCard(){
    let max = deck.length
      ...
      console.log(card1)
      document.getElementById("player-hand").appendChild(card1)
  }
  ...
  function hiddenCard(){
    ...
    console.log(card1)
    document.getElementById("dealer-hand").appendChild(card1)}
...
buildDeck()
  document.getElementById("deal-button").addEventListener('click', function() {
    ...
    setTimeout(function() {playerCard()}, 500) 

    setTimeout(function() {dealerCard()}, 1000) 
    
    setTimeout(function() {playerCard()}, 1500) 
  ...
  document.getElementById("stand-button").addEventListener('click', function() {
    ...
    else if (playerPoints > dealerPoints && playerPoints < 22 && dealerPoints < 22) {console.log(`Player has ${playerPoints}, dealer has ${dealerPoints}`);setTimeout(function(){alert("You win! Play again?"); location.reload()}, 1008)}
  })
  })
